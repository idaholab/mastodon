// MASTODON includes
#include "ComputeElasticityIsolator.h"
...
template <>
InputParameters
validParams<ComputeElasticityIsolator>()
{
...
ComputeElasticityIsolator::ComputeElasticityIsolator(const InputParameters & parameters)
  : Material(parameters),
...
void
ComputeElasticityIsolator::initQpStatefulProperties()
{
...
void
ComputeElasticityIsolator::computeQpProperties()
{
