...
class TestEvent(unittest.TestCase):
    ...
    def testBasicEvent(self):
        ...
        self.assertEqual(
            "Comparison with between 'int' type is not valid.", str(cm.exception)
        )
    ...
    def testProb(self):
        ...
        self.assertIn(
            "requires two inputs: Mean/Median and Standard_Deviaton", str(cm.exception)
        )
        ...
        self.assertIn(
            "requires only one input: Mean/Median probability", str(cm.exception)
        )
